...
import '../../cart_address/cart.dart';

class ElectronicsItem extends StatefulWidget {
  @override
  _ElectronicsItemState createState() => _ElectronicsItemState();
}

class _ElectronicsItemState extends State<ElectronicsItem> {
  bool vegOnly = false;
  bool option1 = false;
  bool option2 = false;
  ...
  Widget build(BuildContext context) {
    merchants restaurant = ModalRoute.of(context).settings.arguments;
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                      width: 1.0,
                      color:
                      (item[index].type == 'veg') ? Colors.green : Colors.red),
                ),
                child: Container(
                  width: 16.0,
                  height: 16.0,
