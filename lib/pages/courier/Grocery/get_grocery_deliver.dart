...
import '../Food/restaurant_items.dart';
      ...
      child: Scaffold(
        ...
        body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final List<merchants> item = _GroceryList;
            return InkWell(
              onTap: () {

                Navigator.pushNamed(context,"GroceryItems",arguments:_GroceryList[index]);
                CartItem cartitem= Provider.of<CartItem>(context, listen: false);
                cartitem.rests.clear();
                cartitem.Markets.clear();
                cartitem.AddRest(_GroceryList[index]);
