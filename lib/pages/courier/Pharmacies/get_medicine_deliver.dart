...
class GetMedicineDeliver extends StatefulWidget {
  @override
  _GetMedicineDeliverState createState() => _GetMedicineDeliverState();
}

class _GetMedicineDeliverState extends State<GetMedicineDeliver> {
  final _PharmacyList = [
    merchants(
        name: 'we care',
      ...
      child: Scaffold(
        ...
        body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final List<merchants> item = _PharmacyList;
            return InkWell(
              onTap: () {

                Navigator.pushNamed(context,"MedicineItem",arguments:_PharmacyList[index]);
                CartItem cartitem= Provider.of<CartItem>(context, listen: false);
                cartitem.rests.clear();
                cartitem.Markets.clear();
                cartitem.AddRest(_PharmacyList[index]);
