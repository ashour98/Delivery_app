...
class GetFlowersDeliver extends StatefulWidget {
  @override
  _GetFlowersDeliverState createState() => _GetFlowersDeliverState();
}

class _GetFlowersDeliverState extends State<GetFlowersDeliver> {
  final _FlowersList = [
    merchants(
        name: 'Yasmine ',
      ...
      child: Scaffold(
        ...
        body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final List<merchants> item = _FlowersList;
            return InkWell(
              onTap: () {

                Navigator.pushNamed(context,"FlowersItem",arguments:_FlowersList[index]);
                CartItem cartitem= Provider.of<CartItem>(context, listen: false);
                cartitem.rests.clear();
                cartitem.Markets.clear();
                cartitem.AddRest(_FlowersList[index]);
